...
# Reference Core from the CARLA 2026 paper, "MinorFlow: A gem5 Pipeline
# Visualizer for Teaching Computer Architecture". Single-issue in-order 64-bit
# MinorCPU at 100 MHz, 16 KiB L1I, 32 KiB L1D, matching Table 1 of the paper.
